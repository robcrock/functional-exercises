...
// Your Code here
// const captains = characters.filter((obj, index, arr) => obj.role === 'Captain');
// const captainNames = captains.map((obj, index, arr) => obj.name);
...
const groupedCharacters = characters.reduce((acc, curr, i, arr) => {
  acc[curr.universe] =
    acc[curr.universe] === undefined ? [] : acc[curr.universe];
